...
<table  id="myTable" style="margin-top: -150px;margin-left: 400px;">
  ...
  <tr>
    ...
    <td><div><iframe width="500" height="200" src="https://www.youtube.com/embed/2dZiMBwX_5Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></td>
  </tr>
  <tr>
    <td style="color: gray">oops concept/classes and objects</td>
    <td><div><iframe width="500" height="200" src="https://www.youtube.com/embed/7GwptabrYyk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></td>
  </tr>
  <tr>
    <td style="color: gray">Polymorphism</td>
    <td><div><iframe width="500" height="200"  src="https://www.youtube.com/embed/qqYOYIVrso0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div></td>
  </tr>
  <tr>
    <td style="color: gray">inheritence</td>
    <td><div><iframe width="500" height="200" src="https://www.youtube.com/embed/nixQyPIAnOQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div></td>
  </tr>
  <tr>
    <td style="color: gray">Abstraction/virtual functions</td>
    <td><div><iframe width="500" height="200"  src="https://www.youtube.com/embed/RcIsb9iFKH8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></td>
  </tr>
  <tr>
    <td style="color: gray">encapsulation</td>
    <td><div><iframe width="500" height="200" src="https://www.youtube.com/embed/tt_astMjep0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen> </iframe> </div></td>
  </tr>
</table>
